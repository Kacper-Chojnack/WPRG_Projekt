...
$sql = "SELECT quiz_name, question_count, author_login, creation_date, execution_count FROM Quiz";
...
<head>
    <meta charset="UTF-8">
    <title>Lista quizów - LeisureTime!</title>
...
<main class="container mx-auto mt-8">
    <h1 class="text-3xl font-bold mb-4 flex items-center justify-center">Lista quizów</h1>
    <div class="mx-auto">
            ...
            while ($row = $result->fetch_assoc()):
                ...
                <tr>
                    <td class="border px-4 py-2">
                        <a href="quiz.php?nazwa=<?php echo $nazwa; ?>" class="text-red-500 font-bold hover:underline">
                            <?php echo $nazwa; ?>
                        </a>
                    </td>
